...
const DaftarBuah =() =>{
    ...
    useEffect(() => {
      ...
      const handleDelete = (event) =>{
        ...
        axios.delete(`http://backendexample.sanbercloud.com/api/fruits/{ID_FRUIT}/${idDataBuah}`)
        .then(res => {
      ...
      const handleSubmit =(event) =>{
        ...
        if ( input.id === null){
            axios.post(`http://backendexample.sanbercloud.com/api/fruits/{ID_FRUIT}`, { name,price,weight:input.weight})
            .then(res => {
            ...
            axios.put(`http://backendexample.sanbercloud.com/api/contestants/${input.id}`, { name,price,weight:input.weight})
            .then(()=> {
